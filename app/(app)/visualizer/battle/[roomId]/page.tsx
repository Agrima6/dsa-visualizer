  ...
  if (room.status === "waiting") {
    return (
      <div className="container mx-auto max-w-xl space-y-6">
        <div className="rounded-[24px] border border-violet-500/15 bg-white/70 p-8 text-center shadow-[0_10px_35px_rgba(139,92,246,0.06)] backdrop-blur-xl dark:bg-white/[0.04]">
          ...
          <div className="mt-4 flex items-center gap-2 rounded-xl border border-violet-500/15 bg-white/70 px-3 py-2 dark:bg-white/[0.04]">
            <code className="flex-1 truncate text-left text-xs">{origin ? `${origin}/visualizer/battle/${roomId}` : "…"}</code>
            <button onClick={copyInvite} className="flex items-center gap-1 rounded-lg border border-violet-500/20 px-2 py-1 text-xs font-semibold text-muted-foreground hover:text-foreground">
      ...
      <div className="container mx-auto max-w-xl space-y-6">
        <div className="rounded-[24px] border border-violet-500/15 bg-white/70 p-8 text-center shadow-[0_10px_35px_rgba(139,92,246,0.06)] backdrop-blur-xl dark:bg-white/[0.04]">
          ...
          <button
            ...
            className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-blue-600 py-2.5 text-sm font-semibold text-white"
          >
          ...
          {finishedAllQuestions ? (
            ...
            <div className="rounded-[24px] border border-violet-500/15 bg-white/70 p-6 shadow-[0_10px_35px_rgba(139,92,246,0.06)] backdrop-blur-xl dark:bg-white/[0.04]">
              <div className="mb-2 flex flex-wrap items-center gap-2">
                <span className="rounded-full border border-violet-500/20 px-2.5 py-0.5 text-xs font-semibold text-violet-600 dark:text-violet-300">{question.difficulty}</span>
                <span className="rounded-full border border-violet-500/20 px-2.5 py-0.5 text-xs font-semibold text-muted-foreground">{question.topic}</span>
              </div>
              ...
              <textarea
                ...
                spellCheck={false}
                className="mt-4 h-56 w-full resize-none rounded-xl border border-violet-500/15 bg-neutral-950 p-4 font-mono text-[13px] leading-relaxed text-emerald-300 outline-none focus:border-violet-500/40"
              />
