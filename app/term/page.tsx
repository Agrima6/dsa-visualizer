      ...
      <div className="container mx-auto max-w-3xl px-4 py-16 md:py-24">
        ...
        <div className="space-y-10">
          ...
          <Section number="7" title="Your Rights">
            ...
            <p className="mt-3">To exercise any of these rights, please contact us at{" "}
              <a href="mailto:support@algomaitri.com" className="text-violet-600 underline underline-offset-4 hover:text-violet-700 dark:text-violet-400">
